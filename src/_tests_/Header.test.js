...
describe("<Header />", () => {
  ...
  it("renders a logo with a src and alt", () => {
    ...
    expect(logo).toHaveAttribute(
      "src",
      "https://images.unsplash.com/photo-1627608221028-63314f261558?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    );
    expect(logo).toHaveAttribute(
      "alt",
      "Big Cat Tinder logo with outline of cat"
    );
  });
